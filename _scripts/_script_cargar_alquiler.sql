...
EXEC [db_alquileres_vehiculos].[negocio].[sp_Insertar_Alquiler] 1, '35782388', 2, '2025-09-21', NULL 
EXEC [db_alquileres_vehiculos].[negocio].[sp_Insertar_Alquiler] 1, '35782388', 2, '2025-09-21', NULL
EXEC [db_alquileres_vehiculos].[negocio].[sp_Insertar_Alquiler] 1, '35782388', 1, '2025-09-21', NULL
EXEC [db_alquileres_vehiculos].[negocio].[sp_Insertar_Alquiler] 1, '35782388', 1, '2025-09-21', NULL
...
EXEC [db_alquileres_vehiculos].[negocio].[sp_Generar_Factura] 1, '35782388', '2025-09-21', @CF,  NULL
